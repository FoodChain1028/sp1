...
use crate::syscall::precompiles::square::{SquareChip, SquareSyscall};
...
pub enum SyscallCode {
    ...
    SQR = 0x00_00_01_55, // the number is arbitrary here.
}
...
pub fn default_syscall_map() -> HashMap<SyscallCode, Arc<dyn Syscall>> {
    ...
    syscall_map.insert(SyscallCode::UINT256_MUL, Arc::new(Uint256MulChip::new()));
    syscall_map.insert(SyscallCode::SQR, Arc::new(SquareChip::new()));
    syscall_map
}
